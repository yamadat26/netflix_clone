...
$plan->setName('Reeceflix monthly subscription')
  ->setDescription('Get you all features of our site.')
  ->setType('INFINITE');
...
$paymentDefinition->setName('Regular Payments')
  ...
  ->setAmount(new Currency(array('value' => 980, 'currency' => 'JPY'))); 
...
$merchantPreferences->setReturnUrl($returnUrl . "?success=true")
  ...
  ->setSetupFee(new Currency(array('value' => 980, 'currency' => 'JPY')));
